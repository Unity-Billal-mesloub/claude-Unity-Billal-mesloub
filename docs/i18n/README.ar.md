...
اخترنا رخصة الذاكرة الوكيلية الدائمة (durable agentic memory) ينبغي أن يكون من السهل تضمينها في أدوات المطورين، والوكلاء المحليين، وخوادم MCP، وأنظمة المؤسسات، ومنظومات الروبوتات، وأطر تشغيل الوكلاء في الإنتاج.
...
**ملاحظة حول Ragtime**: دليل `ragtime/` مرخّص بموجب **رخصة **. راجع [ragtime/LICENSE](ragtime/LICENSE) للتفاصيل.
